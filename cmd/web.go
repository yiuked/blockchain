...
func Cors() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if headerStr != "" {
			headerStr = fmt.Sprintf("access-controller-allow-origin, access-controller-allow-headers, %s", headerStr)
		} else {
			headerStr = "access-controller-allow-origin, access-controller-allow-headers"
		}
		if origin != "" {
